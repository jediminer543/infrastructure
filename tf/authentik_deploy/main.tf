...
data "helm_template" "authentik" {
  name       = "lhs-authentik"
  namespace  = "NAMESPACE_HERE"//kubernetes_namespace.namespace.metadata[0].name
...
- AUTHENTIK_SECRET_KEY:
  ...
  */
  set {
    ...
    value = "SECRET_NAME_HERE"//kubernetes_secret_v1.authentik_secret.metadata[0].name
  }
  /*
  set {
  ...
  */
  ...
  set {
    ...
    value = "PVC_NAME_HERE" //kubernetes_persistent_volume_claim_v1.authentik_media.metadata[0].name
  }
  /*
  dynamic "set" {
